...
const JoinVibrant = () => {
    return (
        <div className="relative w-full min-h-[600px] overflow-hidden wraplegacySection pt-20 pb-20">
            ...
            ></div>
            <div className="items-start text-center md:text-left relative z-10 flex flex-col md:flex-row justify-between  w-full md:w-[80%] mx-auto p-5 min-h-[600px]">
                <div className="w-full md:w-[60%] mb-8 md:mb-0 md:pr-5">
                    <h1 className="text-[40px] md:text-[93px] mb-4 font-NeueHaasDisplayLight text-[#fff]">Join a vibrant<br />
                ...
                <div className="w-full md:w-1/2 max-w-[350px]">
                    ...
                    />
                    <p className='font-NeueHaasDisplayLight text-[22px] text-[#fff] pt-[25px] md:pt-[0]'>Connect, share stories, and celebrate the spirit of adventure as we journey together on the open road and explore new horizons.</p>
